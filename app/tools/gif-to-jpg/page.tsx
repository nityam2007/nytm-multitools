// GIF to JPG Converter | TypeScript
"use client";
...
const tool = getToolBySlug("gif-to-jpg")!;
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "gif-to-jpg");
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>Extracts first frame from animated GIFs. Transparent areas become white.</p>
        </div>
      </div>
    </ToolLayout>
  );
