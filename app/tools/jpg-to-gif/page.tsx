...
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "jpg-to-gif");
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-xl mx-auto space-y-6">
          ...
          <>
            ...
            {convertedSize > 0 && (
              <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-[var(--muted)]">
                ...
                <div className="text-center">
                  <div className="text-xs text-[var(--muted-foreground)]">Converted GIF</div>
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>Creates a static GIF. Limited to 256 colors. May lose quality on complex photos.</p>
        </div>
      </div>
    </ToolLayout>
  );
