...
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "png-to-pdf");
    ...
    try {
      ...
      for (let i = 0; i < images.length; i++) {
        ...
        if (pageSize === "fit") {
          ...
          const margin = pageSize === "a4" ? 10 : 12.7; // 10mm or 0.5in
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <button
          ...
          className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
        >
          {converting ? (
            <>
