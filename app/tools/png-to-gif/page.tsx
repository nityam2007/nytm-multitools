// PNG to GIF Converter | TypeScript
"use client";
...
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "png-to-gif");
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>Creates a static GIF. Limited to 256 colors. For animated GIFs, use specialized tools.</p>
        </div>
      </div>
    </ToolLayout>
  );
