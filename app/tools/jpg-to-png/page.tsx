// JPG to PNG Converter | TypeScript
"use client";
...
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "jpg-to-png");
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-xl mx-auto space-y-6">
        ...
        {image && (
          <>
            ...
            {convertedSize > 0 && (
              <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-[var(--muted)]">
                <div className="text-center">
                  <div className="text-xs text-[var(--muted-foreground)]">Original JPG</div>
            ...
            <button
              onClick={convert}
              disabled={converting}
              className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
            >
              {converting ? (
                <>
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>PNG is lossless and supports transparency. Note: File size may increase compared to JPG.</p>
        </div>
      </div>
    </ToolLayout>
  );
