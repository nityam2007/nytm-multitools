    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="space-y-6">
        <div className="bg-yellow-500/10 border border-yellow-500/50 rounded-xl p-4 text-yellow-500 text-sm">
          ⚠️ <strong>Disclaimer:</strong> These are randomly generated numbers for testing purposes only. They are not real credit card numbers and cannot be used for actual transactions.
        </div>
