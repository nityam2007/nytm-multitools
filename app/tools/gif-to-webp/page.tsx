// GIF to WebP Converter | TypeScript
"use client";
...
const tool = getToolBySlug("gif-to-webp")!;
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "gif-to-webp");
    ...
    <ToolLayout tool={tool} similarTools={similarTools}>
      <div className="max-w-xl mx-auto space-y-6">
          ...
          <>
            ...
            {convertedSize > 0 && (
              <div className="grid grid-cols-2 gap-4 p-4 rounded-xl bg-[var(--muted)]">
                ...
                <div className="text-center">
                  <div className="text-xs text-[var(--muted-foreground)]">Converted WebP</div>
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>Extracts first frame from animated GIFs. WebP offers great compression with transparency.</p>
        </div>
      </div>
    </ToolLayout>
  );
