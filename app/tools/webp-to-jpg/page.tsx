// WebP to JPG Converter | TypeScript
"use client";
...
const similarTools = getToolsByCategory("converter").filter(t => t.slug !== "webp-to-jpg");
      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="border-2 border-dashed border-[var(--border)] rounded-xl p-8 text-center hover:border-cyan-500/50 transition-colors">
          ...
          <label htmlFor="file-upload" className="cursor-pointer">
            ...
            <p className="font-semibold mb-1">Drop WebP file here</p>
        ...
        <div className="p-4 rounded-xl bg-[var(--muted)] text-sm text-[var(--muted-foreground)]">
          <p>JPG offers excellent compression for photos. Transparent areas will become white.</p>
        </div>
      </div>
    </ToolLayout>
  );
